...
class BusquedaReceta2 extends StatefulWidget {
  const BusquedaReceta2({Key? key}) : super(key: key);

  @override
  State<BusquedaReceta2> createState() => _BusquedaReceta2State();
}

class _BusquedaReceta2State extends State<BusquedaReceta2> {
  @override
